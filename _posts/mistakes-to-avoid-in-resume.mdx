...
-   Some stuff about being a decent, motivated person, that can\'t be
    > quantified in the resume, let\'s skip this.
...
this]{.ul}](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6762156/).
...
+-----------------------------------+---------------------------------+
| **Gollum / Sméagol**              | Date of birth: 2400 Third Age   |
|                                   |                                 |
| ![](vertopal_7c57ceb15098         | Marital Statuses: Single (Yes!) |
| 4bde8f8da357346351a4/media/image1 |                                 |
| .png){width="1.953125546806649in" | Location: Misty Mountains       |
| height="1.5402690288713912in"}    |                                 |
+-----------------------------------+---------------------------------+
...
a \"3\" to a \"4\" score at Kanban?

+----------------+--------------------------+
| **Skills**     | **Full-time experience** |
|                |                          |
| JavaScript 5/5 | Javascript: 3 years      |
|                |                          |
| Rails 5/5      | Rails: 5 years           |
|                |                          |
| Ping pong 5/5  | Go: 1 year               |
|                |                          |
| Scrum 5/5      |                          |
|                |                          |
| Kanban 5/5     |                          |
...
|                                                                      |
| Then making websites was easy, I was in my comfort zone, and the     |
| need for googling was very few and far between, and I quickly felt   |
| like a 4/5.                                                          |
|                                                                      |
| 6 months later, I rarely googled anymore, and felt like a master. I  |
| was finally 5/5!                                                     |
|                                                                      |
| Then I decided to make a game. I needed to learn 2DCanvas, also      |
| audio with Web Audio. Then I needed to learn WebSockets, oh TCP      |
| sucks for that, I needed to know WebRTC this whole time \[5\], well  |
| I am a 2/5 now, I guess.                                             |
|                                                                      |
...
| a lot of things that I haven\'t touched yet. By the time I learn     |
| those things, new things will come, and I will still feel like a     |
| 3/5.                                                                 |
+----------------------------------------------------------------------+

![](vertopal_7c57ceb150984bde8f8da357346351a4/media/image2.png){width="3.65625in"
height="3.0684284776902886in"}
...
+----------------------------------+----------------------------------+
| **Full Stack Engineer @ Evil     | **Full Stack Engineer @ Evil     |
| Corp**                           | Corp**                           |
|                                  |                                  |
| -   Attended meetings            | -   Shipped PWA web application  |
|                                  |     > for Internal pong app for  |
| -   Talked with stakeholders     |     > 50.000 DAU, using React    |
|                                  |     > and Redux                  |
| -   Fixed bugs                   |                                  |
|                                  | -   Architect changes inside the |
| -   Developed technologies       |     > Django project, leveraging |
|     > according to the spec      |     > the strangling pattern to  |
|                                  |     > transition from a monolith |
| -   Used git                     |     > to multiple apps, with     |
|                                  |     > unit test coverage.        |
| Technologies: Go, Java,          |                                  |
| Javascript, League of Legends,   | -   Built and shipped the        |
| React, Vue, Stripe, Python,      |     > payment gateway extension, |
| Pycharm, NPM, Git, Github, Jira, |     > leveraging third-party     |
| Chrome, Frontend, Powerpoint,    |     > APIs like Stripe           |
| Space Cadet Pinball.             |                                  |
+----------------------------------+----------------------------------+
...
during a short period. An example of this is candidates that claim they
...
there was a candidate that claimed that he was working as a full time as
Developer, DevOps, and SDET. You can wear many hats, but doing this
...
working multiple roles was the case before, make more than one resume
for each.
...
This will not disqualify candidates, and will not help either, but most
likely it will be ignored. There are some materials that place a great
exaggeration on these and how they should be done, but you should not
...
say it all, but if it is too long it will definitely get skipped. Best
to keep it short.

**Hobbies**: I would not include this one, but nobody has any problem
with it, just don\'t put something like embezzlement companies in your
free time.
